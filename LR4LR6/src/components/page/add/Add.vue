...
<!--      Блок с выводом резюме -->
      <b-col cols="6" class="form_col form-output border bg_style ">
  ...
  data() {
    return {
      ...
      form: {
        ...
        photo: {label:'Ссылка на фото', values: 'https://cdn.pixabay.com/photo/2018/03/14/18/29/head-3225946_1280.png'},
