<template>
  <div class="main mt-3">
   <b-row class="status m-0 pl-5 pr-5">
     <div class="col-3">
       <b-alert show :variant="status[0].alert" class="title_height d-flex align-items-center justify-content-center border">
     ...
     <div class="col-3">
       <b-alert show :variant="status[1].alert" class="title_height d-flex align-items-center justify-content-center border">
     ...
     <div class="col-3">
       <b-alert show :variant="status[2].alert" class="title_height d-flex align-items-center justify-content-center border">
     ...
     <div class="col-3">
       <b-alert show :variant="status[3].alert" class="title_height d-flex align-items-center justify-content-center border">
...
export default {
  ...
  data() {
    return {
      ...
      status: [
        {label:'Новый', alert: '' },
        {label:'Назначено собеседование', alert: '' },
        {label:'Принят', alert: '' },
        {label:'Отказ', alert: '' },
      ],
      temp: [],
