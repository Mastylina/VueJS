...
export default {
  ...
  methods: {
    getEduc: function () {
      this.educs  = 'Думаю...';
          jsonp('https://api.vk.com/method/database.getUniversities?city_id=' + this.currentCityId + '&country_id=1&count=10&v=5.126&access_token=' + process.env.VUE_APP_ACCESS_TOKEN_VK + '&q=' + this.educ + '', null, (err, data) => {
            if (err) {
